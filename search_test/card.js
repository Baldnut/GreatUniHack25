document.addEventListener('DOMContentLoaded', () => {
    ...
    const triggerButton = document.querySelector('[data-drawer-target="places-drawer"]');
    if (triggerButton) {
        triggerButton.addEventListener('click', () => {
            loadAndShowPlaceDetails(placeId);
        });
    }
    ...
    function populateCard(data) {
        ...
        if (data.photos && data.photos.length > 0) {
            ...
            // The photo name needs to be assembled into a URL.
            // This is a placeholder for how to construct the URL, as it depends on the API.
            // Assuming a pattern here. You might need to adjust this.
